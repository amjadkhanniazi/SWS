    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-white fixed-top">
        <div className="container-fluid">
          ...
          <a className="navbar-brand" target="#" href="dhttps://mdbootstrap.com/docs/stanard/">
            Social Welfare
          </a>
          ...
          <div className="collapse navbar-collapse" id="navbarExample01" style={{marginLeft: "40%"}}>
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link mx-2" href="https://mdbootstrap.com/docs/standard/" target="#">Cases</a>
              </li>
              <li className="nav-item">
                <a className="nav-link mx-2" href="https://mdbootstrap.com/docs/standard/" target="#">Events</a>
              </li>
              <li className="nav-item">
                <a className="nav-link mx-2" href="https://mdbootstrap.com/docs/standard/" target="#">Apply Now</a>
              </li>
              <li className="nav-item">
                <a className="nav-link mx-2" href="https://mdbootstrap.com/docs/standard/" target="#">Login</a>
              </li>
